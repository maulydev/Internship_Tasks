"use client";
import { useMoveToTrash } from "@/hooks/employees";
...
const DeleteConfirmModal = ({
  ...
  const { mutate: moveToTrash, isPending: isDeleting } = useMoveToTrash(selectedEmpId);
    ...
    >
      ...
      >
        <button
          ...
          title={
            isDeleting ? "Cannot close while moving to trash" : "Close modal"
          }
        >
          <CgClose />
        </button>
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-500 font-normal">
            Are you sure you want to move this employee to trash? You can
